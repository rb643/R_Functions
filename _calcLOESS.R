# function to calculate the optimal local regression coefficient
# returns the mean and sd of the optimal fit
# also requires the function calcSD so find the minumum sum of squared errors
